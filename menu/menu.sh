...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/iwan026/permission/main/ipvps > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/iwan026/permission/main/ipvps | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/iwan026/permission/main/ipvps | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/iwan026/permission/main/ipvps | grep $MYIP | awk '{print $3}')
fi
...
echo -e "${BICyan} │  ${BICyan}TELE      :  ${BIYellow}@YuiStores${NC}"
echo -e "${BICyan} │  ${BICyan}DEVELOVER :  ${BIYellow}🇮🇩YuiStore🇮🇩${NC}"
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}" 
