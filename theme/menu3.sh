...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/YuiVPN/permission/main/ipvps > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/YuiVPN/permission/main/ipvps | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/YuiVPN/permission/main/ipvps | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/YuiVPN/permission/main/ipvps | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/YuiVPN/v6/main/versions)
export pak=$( cat /home/.ver)
IPVPS=$(curl -s ipinfo.io/ip )
clear
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │                  ${BIWhite}${UWhite}YUI-VPN${NC}"
echo -e "${BICyan} │"
...
echo -e "${BICyan} │  ${BICyan}DEVELOVER :  ${BIYellow}YUI-VPN${NC}"
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}" 
